...
static void g_setBooks()
{
	const TBook arrBooks[NUM_BK] =
	{
		...
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("Joshua", "bookname"), xc_KJVDataParse::tr("Josh;Jos;Jo", "bookabbr"), "Josh", "JOSH", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), "" },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("Judges", "bookname"), xc_KJVDataParse::tr("Judg;Jdg;Jgs", "bookabbr"), "Judg", "JUDG", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), "" },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("Ruth", "bookname"), xc_KJVDataParse::tr("Ruth;Rut;Ru", "bookabbr"), "Ruth", "RUTH", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), "" },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("1 Samuel", "bookname"), xc_KJVDataParse::tr("1Sam;1Sm", "bookabbr"), "1Sam", "SAM1", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), xc_KJVDataParse::tr("The First Book of Samuel Otherwise Called, The First Book of the Kings", "bookdesc") },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("2 Samuel", "bookname"), xc_KJVDataParse::tr("2Sam;2Sm", "bookabbr"), "2Sam", "SAM2", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), xc_KJVDataParse::tr("The Second Book of Samuel Otherwise Called, The Second Book of the Kings", "bookdesc") },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("1 Kings", "bookname"), xc_KJVDataParse::tr("1Kgs", "bookabbr"), "1Kgs", "KGS1", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), xc_KJVDataParse::tr("The First Book of the Kings Commonly Called, The Third Book of the Kings", "bookdesc") },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("2 Kings", "bookname"), xc_KJVDataParse::tr("2Kgs", "bookabbr"), "2Kgs", "KGS2", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), xc_KJVDataParse::tr("The Second Book of the Kings Commonly Called, The Fourth Book of the Kings", "bookdesc") },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("1 Chronicles", "bookname"), xc_KJVDataParse::tr("1Chr;1Chron;1Ch", "bookabbr"), "1Chr", "CHR1", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), xc_KJVDataParse::tr("The First Book of the Chronicles", "bookdesc") },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("2 Chronicles", "bookname"), xc_KJVDataParse::tr("2Chr;2Chron;2Ch", "bookabbr"), "2Chr", "CHR2", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), xc_KJVDataParse::tr("The Second Book of the Chronicles", "bookdesc") },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("Ezra", "bookname"), xc_KJVDataParse::tr("Ezra;Ezr", "bookabbr"), "Ezra", "EZRA", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), "" },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("Nehemiah", "bookname"), xc_KJVDataParse::tr("Neh", "bookabbr"), "Neh", "NEH", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), "" },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("Esther", "bookname"), xc_KJVDataParse::tr("Est;Esth", "bookabbr"), "Esth", "ESTH", xc_KJVDataParse::tr("OT Narrative", "bookcategory"), "" },
		...
		// ---- Begin New Testament:
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("Matthew", "bookname"), xc_KJVDataParse::tr("Matt;Mt", "bookabbr"), "Matt", "MATT", xc_KJVDataParse::tr("NT Narrative", "bookcategory"), xc_KJVDataParse::tr("The Gospel According to Saint Matthew", "bookdesc") },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("Mark", "bookname"), xc_KJVDataParse::tr("Mark;Mk", "bookabbr"), "Mark", "MARK", xc_KJVDataParse::tr("NT Narrative", "bookcategory"), xc_KJVDataParse::tr("The Gospel According to Saint Mark", "bookdesc") },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("Luke", "bookname"), xc_KJVDataParse::tr("Luke;Lk", "bookabbr"), "Luke", "LUKE", xc_KJVDataParse::tr("NT Narrative", "bookcategory"), xc_KJVDataParse::tr("The Gospel According to Saint Luke", "bookdesc") },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("John", "bookname"), xc_KJVDataParse::tr("John;Jhn;Jn", "bookabbr"), "John", "JOHN", xc_KJVDataParse::tr("NT Narrative", "bookcategory"), xc_KJVDataParse::tr("The Gospel According to Saint John", "bookdesc") },
		{ CRelIndex(0, 1, 1, 0), xc_KJVDataParse::tr("Acts", "bookname"), xc_KJVDataParse::tr("Acts", "bookabbr"), "Acts", "ACTS", xc_KJVDataParse::tr("NT Narrative", "bookcategory"), xc_KJVDataParse::tr("The Acts of the Apostles", "bookdesc") },
...
//		m_bOpenEndedVerse = false;
	...
	if (nVT == VT_VERSE) {
		if (!bPreExisted) {			// Only increment verse counts if this isn't a duplicate (pre-existing) verse.  Otherwise, we'll crash in the word output and summary phase
			...
			Q_ASSERT(m_pBibleDatabase->m_lstBooks.size() > static_cast<unsigned int>(relIndex.book()-1));
