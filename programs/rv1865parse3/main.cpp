...
static void g_setBooks()
{
	const TBook arrBooks[NUM_BK] =
	{
		...
		{ QObject::tr("Joshua", "bookname"), QObject::tr("Josh;Jos;Jo", "bookabbr"), "Josh", "JOSH", QObject::tr("OT Narrative", "bookcategory"), "" },
		{ QObject::tr("Judges", "bookname"), QObject::tr("Judg;Jdg;Jgs", "bookabbr"), "Judg", "JUDG", QObject::tr("OT Narrative", "bookcategory"), "" },
		{ QObject::tr("Ruth", "bookname"), QObject::tr("Ruth;Rut;Ru", "bookabbr"), "Ruth", "RUTH", QObject::tr("OT Narrative", "bookcategory"), "" },
		{ QObject::tr("1 Samuel", "bookname"), QObject::tr("1Sam;1Sm", "bookabbr"), "1Sam", "SAM1", QObject::tr("OT Narrative", "bookcategory"), QObject::tr("The First Book of Samuel Otherwise Called, The First Book of the Kings", "bookdesc") },
		{ QObject::tr("2 Samuel", "bookname"), QObject::tr("2Sam;2Sm", "bookabbr"), "2Sam", "SAM2", QObject::tr("OT Narrative", "bookcategory"), QObject::tr("The Second Book of Samuel Otherwise Called, The Second Book of the Kings", "bookdesc") },
		{ QObject::tr("1 Kings", "bookname"), QObject::tr("1Kgs", "bookabbr"), "1Kgs", "KGS1", QObject::tr("OT Narrative", "bookcategory"), QObject::tr("The First Book of the Kings Commonly Called, The Third Book of the Kings", "bookdesc") },
		{ QObject::tr("2 Kings", "bookname"), QObject::tr("2Kgs", "bookabbr"), "2Kgs", "KGS2", QObject::tr("OT Narrative", "bookcategory"), QObject::tr("The Second Book of the Kings Commonly Called, The Fourth Book of the Kings", "bookdesc") },
		{ QObject::tr("1 Chronicles", "bookname"), QObject::tr("1Chr;1Chron;1Ch", "bookabbr"), "1Chr", "CHR1", QObject::tr("OT Narrative", "bookcategory"), QObject::tr("The First Book of the Chronicles", "bookdesc") },
		{ QObject::tr("2 Chronicles", "bookname"), QObject::tr("2Chr;2Chron;2Ch", "bookabbr"), "2Chr", "CHR2", QObject::tr("OT Narrative", "bookcategory"), QObject::tr("The Second Book of the Chronicles", "bookdesc") },
		{ QObject::tr("Ezra", "bookname"), QObject::tr("Ezra;Ezr", "bookabbr"), "Ezra", "EZRA", QObject::tr("OT Narrative", "bookcategory"), "" },
		{ QObject::tr("Nehemiah", "bookname"), QObject::tr("Neh", "bookabbr"), "Neh", "NEH", QObject::tr("OT Narrative", "bookcategory"), "" },
		{ QObject::tr("Esther", "bookname"), QObject::tr("Est;Esth", "bookabbr"), "Esth", "ESTH", QObject::tr("OT Narrative", "bookcategory"), "" },
		...
		{ QObject::tr("Matthew", "bookname"), QObject::tr("Matt;Mt", "bookabbr"), "Matt", "MATT", QObject::tr("NT Narrative", "bookcategory"), QObject::tr("The Gospel According to Saint Matthew", "bookdesc") },
		{ QObject::tr("Mark", "bookname"), QObject::tr("Mark;Mk", "bookabbr"), "Mark", "MARK", QObject::tr("NT Narrative", "bookcategory"), QObject::tr("The Gospel According to Saint Mark", "bookdesc") },
		{ QObject::tr("Luke", "bookname"), QObject::tr("Luke;Lk", "bookabbr"), "Luke", "LUKE", QObject::tr("NT Narrative", "bookcategory"), QObject::tr("The Gospel According to Saint Luke", "bookdesc") },
		{ QObject::tr("John", "bookname"), QObject::tr("John;Jhn;Jn", "bookabbr"), "John", "JOHN", QObject::tr("NT Narrative", "bookcategory"), QObject::tr("The Gospel According to Saint John", "bookdesc") },
		{ QObject::tr("Acts", "bookname"), QObject::tr("Acts", "bookabbr"), "Acts", "ACTS", QObject::tr("NT Narrative", "bookcategory"), QObject::tr("The Acts of the Apostles", "bookdesc") },
