...
function(project_genver)
	...
	if("${PROJECT_VERSION}" STREQUAL "")
		set_project(VERSION ${CMAKE_PROJECT_VERSION})
		if(NOT "${CMAKE_PROJECT_VERSION_MAJOR}" STREQUAL "")
			set_project(VERSION_MAJOR ${CMAKE_PROJECT_VERSION_MAJOR})
		endif()
		if(NOT "${CMAKE_PROJECT_VERSION_MINOR}" STREQUAL "")
			set_project(VERSION_MINOR ${CMAKE_PROJECT_VERSION_MINOR})
		endif()
		if(NOT "${CMAKE_PROJECT_VERSION_PATCH}" STREQUAL "")
			set_project(VERSION_PATCH ${CMAKE_PROJECT_VERSION_PATCH})
		endif()
		if(NOT "${CMAKE_PROJECT_VERSION_TWEAK}" STREQUAL "")
			set_project(VERSION_TWEAK ${CMAKE_PROJECT_VERSION_TWEAK})
		endif()
	endif()
	...
	if(NOT "${CMAKE_PROJECT_VERSION_PRERELEASE}" STREQUAL "")
		set_project(VERSION_SEMVER "${PROJECT_VERSION}-${CMAKE_PROJECT_VERSION_PRERELEASE}")
	else()
