...
TBook g_arrBooks[NUM_BK] =				// NOTE: Reworked to match MyBible App Format and Naming
{
	...
	{ QObject::tr("Joshua"), "Josh", "Josh", 60, QObject::tr("OT Narative"), "" },
	{ QObject::tr("Judges"), "Judg", "Judg", 70, QObject::tr("OT Narative"), "" },
	{ QObject::tr("Ruth"), "Ruth", "Ruth", 80, QObject::tr("OT Narative"), "" },
	{ QObject::tr("1 Samuel"), "1Sam", "1Sam", 90, QObject::tr("OT Narative"), QObject::tr("The First Book of Samuel Otherwise Called, The First Book of the Kings") },
	{ QObject::tr("2 Samuel"), "2Sam", "2Sam", 100, QObject::tr("OT Narative"), QObject::tr("The Second Book of Samuel Otherwise Called, The Second Book of the Kings") },
	{ QObject::tr("1 Kings"), "1Kgs", "1Kgs", 110, QObject::tr("OT Narative"), QObject::tr("The First Book of the Kings Commonly Called, The Third Book of the Kings") },
	{ QObject::tr("2 Kings"), "2Kgs", "2Kgs", 120, QObject::tr("OT Narative"), QObject::tr("The Second Book of the Kings Commonly Called, The Fourth Book of the Kings") },
	{ QObject::tr("1 Chronicles"), "1Chr", "1Chr", 130, QObject::tr("OT Narative"), QObject::tr("The First Book of the Chronicles") },
	{ QObject::tr("2 Chronicles"), "2Chr", "2Chr", 140, QObject::tr("OT Narative"), QObject::tr("The Second Book of the Chronicles") },
	{ QObject::tr("Ezra"), "Ezra", "Ezr", 150, QObject::tr("OT Narative"), "" },
	{ QObject::tr("Nehemiah"), "Neh", "Neh", 160, QObject::tr("OT Narative"), "" },
	{ QObject::tr("Esther"), "Esth", "Esth", 190, QObject::tr("OT Narative"), "" },
	...
	// ---- Begin New Testament:
	{ QObject::tr("Matthew"), "Matt", "Mat", 470, QObject::tr("NT Narative"), QObject::tr("The Gospel According to Saint Matthew") },
	{ QObject::tr("Mark"), "Mark", "Mar", 480, QObject::tr("NT Narative"), QObject::tr("The Gospel According to Saint Mark") },
	{ QObject::tr("Luke"), "Luke", "Luk", 490, QObject::tr("NT Narative"), QObject::tr("The Gospel According to Saint Luke") },
	{ QObject::tr("John"), "John", "John", 500, QObject::tr("NT Narative"), QObject::tr("The Gospel According to Saint John") },
	{ QObject::tr("Acts"), "Acts", "Acts", 510, QObject::tr("NT Narative"), QObject::tr("The Acts of the Apostles") },
