...
SoundEx::SOUNDEX_LANGUAGES_ENUM SoundEx::languageValue(const QString &strLanguage)
{
...
QString SoundEx::soundEx(const QString &strWordIn, SOUNDEX_LANGUAGES_ENUM nLanguage, int nLength, SOUNDEX_OPTION_MODE_ENUM nOption)
{
