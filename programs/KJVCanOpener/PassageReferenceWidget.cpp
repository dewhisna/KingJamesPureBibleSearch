		...
		m_pActionSelectAll(nullptr)
{
	...
	m_pActionUndo = m_pEditMenu->addAction(tr("&Undo", "MainMenu"), ui.editPassageReference, SLOT(undo()));
	m_pActionUndo->setShortcut(QKeySequence(Qt::CTRL | Qt::Key_Z));
...
//	connect(m_pActionUndo, SIGNAL(triggered()), ui.editPassageReference, SLOT(setFocus()));
	m_pActionRedo = m_pEditMenu->addAction(tr("&Redo", "MainMenu"), ui.editPassageReference, SLOT(redo()));
	m_pActionRedo->setShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_Z));
...
//	connect(m_pActionRedo, SIGNAL(triggered()), ui.editPassageReference, SLOT(setFocus()));
	...
	m_pActionCut = m_pEditMenu->addAction(tr("Cu&t", "MainMenu"), ui.editPassageReference, SLOT(cut()));
	m_pActionCut->setShortcut(QKeySequence(Qt::CTRL | Qt::Key_X));
...
//	connect(m_pActionCut, SIGNAL(triggered()), ui.editPassageReference, SLOT(setFocus()));
	m_pActionCopy = m_pEditMenu->addAction(tr("&Copy", "MainMenu"), ui.editPassageReference, SLOT(copy()));
...
//	connect(m_pActionCopy, SIGNAL(triggered()), ui.editPassageReference, SLOT(setFocus()));
	m_pActionPaste = m_pEditMenu->addAction(tr("&Paste", "MainMenu"), ui.editPassageReference, SLOT(paste()));
	m_pActionPaste->setShortcut(QKeySequence(Qt::CTRL | Qt::Key_V));
...
//	connect(m_pActionPaste, SIGNAL(triggered()), ui.editPassageReference, SLOT(setFocus()));
	m_pActionDelete = m_pEditMenu->addAction(tr("&Delete", "MainMenu"), ui.editPassageReference, SLOT(clear()));
	m_pActionDelete->setShortcut(QKeySequence(Qt::Key_Delete));
...
//	connect(m_pActionDelete, SIGNAL(triggered()), ui.editPassageReference, SLOT(setFocus()));
	m_pEditMenu->addSeparator();
	m_pActionSelectAll = m_pEditMenu->addAction(tr("Select &All", "MainMenu"), ui.editPassageReference, SLOT(selectAll()));
